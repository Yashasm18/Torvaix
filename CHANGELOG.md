...
## [0.3.0](https://github.com/Yashasm18/Torvaix/compare/v0.2.0...v0.3.0) (2026-09-07)


### Features

* **automation:** Autonomous Event-Driven Background Automation & Agent Workflow Engine ([431c501](https://github.com/Yashasm18/Torvaix/commit/431c5013063581dbdf799d195e6daf0444eafbdc))
* **automation:** autonomous event-driven background workflow engine and agent scheduler ([9aed1ef](https://github.com/Yashasm18/Torvaix/commit/9aed1ef683c97f999321b5bec215079450b32c3d))
* **execution:** add real-time task operations center, MCP audit logging, and gated security clearances ([3562dab](https://github.com/Yashasm18/Torvaix/commit/3562dab416cf35d140b29a53148b7dc7e359316a))
...
* **intelligence:** implement autonomous memory consolidation and knowledge synthesis engine ([46b2f30](https://github.com/Yashasm18/Torvaix/commit/46b2f303821254a85fc1406ba4f8f956e9d03249))
...
* **build:** resolve lockfile sync, parallel service runners, port checks, and docker compose env config ([c9c5eab](https://github.com/Yashasm18/Torvaix/commit/c9c5eab2741b150d2dddcdbe4e4dbea3c67ea216))
...
* **lockfile:** synchronize package-lock.json for @torvaix/events dependencies ([12b947c](https://github.com/Yashasm18/Torvaix/commit/12b947cf192c56004915145c066f0a009d480216))
* **security:** resolve CodeQL rate limiting and loop bound alerts ([07ae895](https://github.com/Yashasm18/Torvaix/commit/07ae8956384137a5ba76a09b44e0d0a76260128b))
* **web:** resolve next config esm __dirname and base-ui dialog trigger type error ([d1d28bf](https://github.com/Yashasm18/Torvaix/commit/d1d28bfa5a2ab6635aeccf09e442e54686d9cbaf))


### Documentation

* correct title and fix typo in project description ([7d65479](https://github.com/Yashasm18/Torvaix/commit/7d65479d380c64e3ade0db0f5cdd268d427c70ce))
